...
|------|-------------|------|---------|:--------:|
| <a name="input_security_group_rule_cidr_ip"></a> [security\_group\_rule\_cidr\_ip](#input_security_group_rule_cidr_ip) | The CIDR block allowed by the HTTP and HTTPS security group rules. | `string` | `"0.0.0.0/0"` | no |
